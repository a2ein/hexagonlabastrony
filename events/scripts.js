document.addEventListener('DOMContentLoaded', () => {
    const events = [
        ...
        { name: 'Meteor Shower', date: '2024-05-10', description: '', modelUrl: 'https://youtu.be/S_jdfyp8pL0?si=VC9LLyg9YntVWO6z',img:'img/mete.jpg' },
        ...
        { name: 'Planetary Alignment', date: '2024-06-20', description: 'Multiple planets will align.', modelUrl: 'path_to_planetary_alignment_model' ,img:'img/plane.jpg'},
        { name: 'Super Luna', date: '2024-06-20', description: 'A super moon will be visible from certain regions.', modelUrl: 'https://youtube.com/shorts/mZn0cgw8UWE?si=Mz7dg95J_qhN5jvH',img:'img/superluna.jpg'},
    ];
    ...
    events.forEach(event => {
        ...
        eventItem.innerHTML = `
         ...
         <img src="${event.img}"  alt="img">
            ...
            <button onclick="showEventDetails('${event.img}', ', '${event.modelUrl}')">Upcoming</button>
